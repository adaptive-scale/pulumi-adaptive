...
namespace AdaptiveScale.Adaptive
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/adaptive-scale/pulumi-adaptive";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("AdaptiveScale.Adaptive.version.txt");
    ...
    internal sealed class AdaptiveResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AdaptiveResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
